# 🛠️ 에이정 블로그 기술 명세서 (Technical Specification Master)

> 이 문서는 에이정 공식 블로그의 완전한 기술 스펙을 정의합니다.
...
### 목적
댄 아브라모프의 `overreacted.io`를 벤치마킹하여 **극도로 빠른 로딩 속도**와 **탁월한 사용자 경험**을 제공하는 한글 블로그 플랫폼 구축
...
```
1. 빌드 타임
   Markdown 파일 → gray-matter → Post 객체 배열 → 정적 HTML 생성
...
# 사이트 URL
NEXT_PUBLIC_SITE_URL=https://blog.aijeong.com
```
...
이 스펙대로 구현하면 **세계 최고 수준의 블로그 성능**을 달성할 수 있습니다.
